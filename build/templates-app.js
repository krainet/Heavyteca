angular.module('templates-app', ['about/about.tpl.html', 'albums/albums.tpl.html', 'animate/animate.tpl.html', 'apitest/apitest.tpl.html', 'auth/auth-facebook.tpl.html', 'auth/auth.tpl.html', 'bandas/bandas.tpl.html', 'generos/generos.tpl.html', 'home/home.tpl.html', 'infinite/infinite.tpl.html', 'uibootstrap/uibootstrap.tpl.html']);
...
angular.module("albums/albums.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("albums/albums.tpl.html",
    "<div class=\"row\">\n" +
    "    <div class=\"column col-md-12\">\n" +
    "        <img src=\"../assets/imglocal/guitarbackground.png\" class=\"img-responsive img75percent\">\n" +
    "        <span class=\"gridtitle\">HEAVY TECA - {{model.pageTitle}}</span>\n" +
    "    </div>\n" +
    "</div>\n" +
    "\n" +
    "<p>&nbsp;</p>\n" +
    "\n" +
    "<div class=\"row\">\n" +
    "    <div class=\"column col-md-12 topborder backgroundgrid\" ng-repeat=\"item in model.data\">\n" +
    "        <div class=\"column col-md-4 col10xmargin\">\n" +
    "            <img class=\"img-circle gridimage\" src=\"../assets/img/{{item.image}}\">\n" +
    "        </div>\n" +
    "        <div class=\"column col-md-8 col10xmargin\">\n" +
    "            <h4>{{item.title}}</h4>\n" +
    "            <h5>{{item.band.name}}</h5>\n" +
    "            <h6>{{item.genre.name}}</h6>\n" +
    "            <button class=\"btn btn-info\"><i class=\"fa fa-music\"></i> Tracklist</button>\n" +
    "        </div>\n" +
    "    </div>\n" +
    "</div>\n" +
    "");
...
angular.module("bandas/bandas.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("bandas/bandas.tpl.html",
    "<div class=\"row\">\n" +
    "    <div class=\"column col-md-12\">\n" +
    "        <img src=\"../assets/imglocal/guitarbackground.png\" class=\"img-responsive img75percent\">\n" +
    "        <span class=\"gridtitle\">HEAVY TECA - {{model.pageTitle}}</span>\n" +
    ...
    "        <div class=\"column col-md-8 col10xmargin\">\n" +
    "            <div class=\"row\">\n" +
    "                <div class=\"column col-md-4\" style=\"width:49%\">\n" +
    "                    <ul class=\"ultoleft\">\n" +
    "                        <li ng-repeat=\"album in item.albums\">{{album.title}} ({{album.year}})</li>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "                <div class=\"column col-md-4\" style=\"width:49%\">\n" +
    "                    <ul class=\"ultoleft\">\n" +
    "                        <li ng-repeat=\"member in item.members\">{{member.name}}</li>\n" +
    "                    </ul>\n" +
    "                </div>\n" +
    "            </div>\n" +
    "        </div>\n" +
...
angular.module("generos/generos.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("generos/generos.tpl.html",
    "<div class=\"row\">\n" +
    "    <div class=\"column col-md-12\">\n" +
    "        <img src=\"../assets/imglocal/guitarbackground.png\" class=\"img-responsive img75percent\">\n" +
    "        <span class=\"gridtitle\">HEAVY TECA - {{model.pageTitle}}</span>\n" +
    ...
    "        <div class=\"column col-md-8 col10xmargin\">\n" +
    "            <ul class=\"ultoleft\">\n" +
    "                <li ng-repeat=\"album in item.albums\">\n" +
    "                    {{album.title}} ({{album.year}})\n" +
    "                    <button ui-sref=\"root.bandas({ id: album.$$hashKey })\" class=\"btn btn-info btn-xs\"><i class=\"fa fa-eye\"></i></button>\n" +
    "                </li>\n" +
    "            </ul>\n" +
    "        </div>\n" +
    "    </div>\n" +
